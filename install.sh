...
ACTIVE_RESPONSE_PERMANENT_BLOCK_ENABLED="${ACTIVE_RESPONSE_PERMANENT_BLOCK_ENABLED:-}"
ACTIVE_RESPONSE_PERMANENT_BLOCK_THRESHOLD="${ACTIVE_RESPONSE_PERMANENT_BLOCK_THRESHOLD:-}"
ACTIVE_RESPONSE_PERMANENT_BLOCK_WINDOW_SECONDS="${ACTIVE_RESPONSE_PERMANENT_BLOCK_WINDOW_SECONDS:-}"
...
configure_active_response() {
  if [ -z "$ACTIVE_RESPONSE_ENABLED" ] \
    ...
    && [ -z "$ACTIVE_RESPONSE_PERMANENT_BLOCK_ENABLED" ] \
    && [ -z "$ACTIVE_RESPONSE_PERMANENT_BLOCK_THRESHOLD" ] \
    && [ -z "$ACTIVE_RESPONSE_PERMANENT_BLOCK_WINDOW_SECONDS" ] \
  ...
  if [ -n "$ACTIVE_RESPONSE_PERMANENT_BLOCK_ENABLED" ]; then
    set_toml_value "$config_path" "active_response" "permanent_block_enabled" "$(toml_bool "$ACTIVE_RESPONSE_PERMANENT_BLOCK_ENABLED")"
  fi
  if [ -n "$ACTIVE_RESPONSE_PERMANENT_BLOCK_THRESHOLD" ]; then
    set_toml_value "$config_path" "active_response" "permanent_block_threshold" "$ACTIVE_RESPONSE_PERMANENT_BLOCK_THRESHOLD"
  fi
  if [ -n "$ACTIVE_RESPONSE_PERMANENT_BLOCK_WINDOW_SECONDS" ]; then
    set_toml_value "$config_path" "active_response" "permanent_block_window_seconds" "$ACTIVE_RESPONSE_PERMANENT_BLOCK_WINDOW_SECONDS"
  fi
